...
public class TorchSwitch extends BroadcastReceiver {
    ...
    public static final String TOGGLE_FLASHLIGHT = "com.oteyp.elfeneri.TOGGLE_FLASHLIGHT";
    public static final String TORCH_STATE_CHANGED = "com.oteyp.elfeneri.TORCH_STATE_CHANGED";
